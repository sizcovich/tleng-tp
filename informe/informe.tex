...
\textbf{E} $\rightarrow$ var \\
\textit{\{E.value = var.value\}} \\

\textbf{E} $\rightarrow$ var \textbf{C} \\
\textit{\{E.value = var.value + C.value\}} \\
...
\textbf{C} $\rightarrow$ += \textbf{NUM} \\
\textit{\{ C.value = '+=' + NUM.value\}} \\
