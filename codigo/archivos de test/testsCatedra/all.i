    siete = false;              hola=[1,2,3][2]; f = false; x = "y"; y = "x";
campo = [{campo:"1"},{campo:"2"},{campo:"3"}][1]; campo= {e:2,eda:["a"][2+4],A:8.5};
...
=(b>10))
             ...
             while(5>10)
for(;        true;){#AA#AA
             if(f) {print(x+"x");} else {do print("y"+y); while(1==1); aa = true AND false; bb = NOT aa;
}print({dos:[1,2,3][2*3]}.dos + {e:"a",j:j,r:5.5}.r);}

if (algo) if(no)print(2);else while(amarillo) do #NADA
#DE
